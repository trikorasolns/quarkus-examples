...
public class FruitRepository {
  ...
  public Uni<List<Fruit>> findByTree(String treeName) {
    return sf.withSession(s -> s.createNamedQuery("Fruit.fetchByTree", Fruit.class).setParameter("tree", treeName).getResultList());
  }
